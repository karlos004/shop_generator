  ...
  <div class="container products">
      <div class="page-wrapper">
        <div class="search-wrapper">
            ...
            <nuxt-link to="/products/edit/add"><button class="butt">Add new product</button></nuxt-link>
            <nuxt-link to="/products/edit/newCategory"><button class="butt">Add new category</button></nuxt-link>
        </div>
