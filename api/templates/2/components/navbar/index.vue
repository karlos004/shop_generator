<template>
  <nav class="navbar">
    ...
    <nuxt-link to="/" class="logo">{{ $store.getters.appName }}</nuxt-link>
    ...
    <ul v-else class="main-nav" id="js-menu">
      ...
      <li>
        <div class="dropdown hide-on-mobile" >
          <a class="dropbtn">{{ loggedInUser.email }}
          ...
          <div class="dropdown-content">
            ...
            <nuxt-link to="/" class="nav-links">Profile</nuxt-link>
            <nuxt-link v-if="loggedInUser.role == 2" to="/" class="nav-links">Shop users</nuxt-link>
            <nuxt-link v-if="loggedInUser.role == 2" to="/products/edit" class="nav-links">Manage products</nuxt-link>
